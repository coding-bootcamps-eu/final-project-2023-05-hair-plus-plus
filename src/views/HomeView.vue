<template>
  <div>
    ...
    <div class="container">
      <button @click="routeToCustomerForm" type="button">+ new Customer</button>
      <button @click="viewCustomers" type="button">Customers</button>
    </div>
  </div>
</template>
...
button:hover {
  box-shadow: 0px 0px 10px 3px rgb(238, 226, 47);
}
</style>
